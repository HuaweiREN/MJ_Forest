"use strict";
cc._RF.push(module, '5a9699dl1JL2p2zqR98YAzV', 'cPetDining');
// Script/ContentScript/cPetDining.js
...
cc.Class({
    ...
    //// 20200302
    setNodeandData: function setNodeandData() {
    ...
    //// 20200301
    updateFeedDataTemp: function updateFeedDataTemp() {
        this._datafeedMax = GlobalFuncVar.userPetInfo.petExpeTotNow - GlobalFuncVar.userPetInfo.petExpeValueNow;
        var handleMaxPosX = this._datafeedMax / GlobalFuncVar.userInfo.foodHoldVolume;
        var handlePosRate = this._feedVolume.getComponent(cc.Slider).progress;
    ...
    //// 20200302
    onClickFeedConfirmBtn: function onClickFeedConfirmBtn() {
    ...
    eventAfterSync_notLevelUp: function eventAfterSync_notLevelUp(rcvDataPack) {
        if (rcvDataPack) {
    ...
    eventAfterSync_LevelUp: function eventAfterSync_LevelUp(rcvDataPack) {
        if (rcvDataPack) {
            GlobalFuncVar.userInfo.foodHoldVolume = rcvDataPack.rcvData[0];
