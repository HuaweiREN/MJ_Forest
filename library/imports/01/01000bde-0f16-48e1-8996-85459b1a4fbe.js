"use strict";
cc._RF.push(module, '01000veDxZI4YmWhUWbGk++', 'cSync');
// Script/ContentScript/cSync.js
...
cc.Class({
    ...
    onClickSyncBtn: function onClickSyncBtn() {
        var emitDataPack = {
            emitID: [44, 45],
    ...
    eventAfterSync_SyncBtn: function eventAfterSync_SyncBtn(rcvDataPack) {
        if (rcvDataPack == true) {
    ...
    updateProgressBar: function updateProgressBar(progressBar, noti, dt) {
